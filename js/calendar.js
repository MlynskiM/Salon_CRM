function displayCalendar(DateVariable){
    ...
    +`<a class='ArrowLeft' onclick='CalendarSlider(1)'> <i class='fas fa-angle-double-left'></i> </a><span class="date-block">`
    +monthNames[month]+" "+ year 
    +`</span><a class='ArrowRight' onclick='CalendarSlider(2)'><i class='fas fa-angle-double-right'></i></a>`
    +"</th></tr>";
